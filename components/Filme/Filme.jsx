    ...
    <View style={Styles.background}>
      <View style={Styles.grid_carrosel}>
        <View style={[Styles.seta, { flexDirection: "row" }]}>
          ...
          <Image
            style={[Styles.icon_save, { marginTop: 30, marginLeft: 70 }]}
        ...
        >
          ...
          Doutor Estranho. Quando um feitiço para reverter o evento não sai como
          o esperado, o Homem-Aranha e seu companheiro dos Vingadores precisam
        ...
        <Pressable style={Styles.pressable}>
          <View style={{ flexDirection: "row", gap: 7 }}>
            ...
            />
            <Text
              style={{ fontFamily: "texto", fontWeight: "bold", fontSize: 15 }}
            >
              Avaliar
            </Text>
          </View>
