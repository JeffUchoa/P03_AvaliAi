import { View, Text, Button, Pressable, Image, FlatList, SectionList, TextInput } from "react-native";
        ...
        <View style={Styles.background}>
            <View style={Styles.grid}>
                ...
                <View style={Styles.form}>
                    ...
                    />
                    <Text
                        style={{ fontFamily: "texto", color: "white",fontWeight:"bold",marginTop:15 }}
                    >
                        Esqueceu a senha?
                    </Text>
                ...
                <View>
                    <Text
                        style={[Styles.texto, { fontFamily: "texto", color: "white" }]}
                    >
                        Ou entre com
                    </Text>
                ...
                <Text
                    style={[Styles.texto, { fontFamily: "texto", color: "white",fontWeight:"bold" }]}
                >
